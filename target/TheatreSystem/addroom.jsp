 ...
 <%@ include file="./page/navbar.jsp" %><br>
   ...
   <form method="post" action="rooms">
     <div class="form-group">
       <label for="name" class="grey-text font-weight-light">Room Name</label>
     ...
     <div class="form-group">
       ...
       <input type="text" class="form-control" name="noOfSeats" id="noOfSeats" placeholder="Enter No of Seats">
     </div>

    <div class="form-group">
        <label for="roomPic" class="grey-text font-weight-light">Add Room Picture</label>
       <input type="file" name="roomPic" id="roomPic"><br><br>
    </div>
     <button type="submit" id="btnSaveRoom"class="btn btn-primary">Submit</button>
   </form>
